...
const navigate = useNavigate()
    ...
    return (
      ...
      <div className="relative">
        ...
        <div>
          <h1 className="text-5xl lg:text-7xl animate-fade-right animate-duration-1000 animate-delay-1000 hidden md:flex left-5 absolute top-10 w-min font-bold text-white bg-[#828584] py-4 px-8 bg-opacity-70 rounded-2xl">
            FAQ
          </h1>
          <button 
            onClick={() => navigate('/appointment')} 
            className="text-3xl animate-fade-left animate-duration-1000 animate-delay-1000 lg:text-4xl gap-5 hidden md:flex items-center absolute right-6 bottom-6 font-bold text-white bg-[#DDACCB] py-4 px-8 rounded-2xl"
          >
            Appointment  
